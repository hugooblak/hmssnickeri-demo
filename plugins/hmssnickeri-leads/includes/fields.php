...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'hmssnickeri-leads' ),
				'storm'       => __( 'Storm or hail damage', 'hmssnickeri-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'hmssnickeri-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'hmssnickeri-leads' ),
				'not-sure'    => __( 'Vet inte än', 'hmssnickeri-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'hmssnickeri-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'hmssnickeri-leads' ),
				'research' => __( 'Jag kollar bara priser', 'hmssnickeri-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'hmssnickeri-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'hmssnickeri-leads' ),
		'contacted' => __( 'Kontaktad', 'hmssnickeri-leads' ),
		'quoted'    => __( 'Quote sent', 'hmssnickeri-leads' ),
		'won'       => __( 'Won', 'hmssnickeri-leads' ),
		'lost'      => __( 'Lost', 'hmssnickeri-leads' ),
		'spam'      => __( 'Misstänkt spam', 'hmssnickeri-leads' ),
	);
}
